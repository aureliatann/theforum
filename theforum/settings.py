...
SECRET_KEY = 'django-insecure-5e)x%e2g6@nyk0m-484ewflo$l0jhr^2(e@qa$8edp(s+9bl6u'
...
INSTALLED_APPS = [
    ...
    'attendees', # new attendees app
    'widget_tweaks', # for add_class (for loading buffer)
]
